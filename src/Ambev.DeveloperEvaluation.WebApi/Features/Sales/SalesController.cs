...
public class SalesController : BaseController
{
    ...
    /// <summary>
    /// Retrieves a list of sales with pagination, filtering and ordering
    /// </summary>
    [HttpGet]
    ...
    public async Task<IActionResult> ListSales([FromQuery] ListSalesRequest request, CancellationToken cancellationToken)
    {
        ...
        return Ok(new PaginatedResponse<GetSaleResponse>
        {
            ...
            Data = _mapper.Map<List<GetSaleResponse>>(result.Items),
    ...
    /// <summary>
    /// Updates an existing sale, replacing its items and recalculating discounts/totals
    /// </summary>
    [HttpPut("{id}")]
